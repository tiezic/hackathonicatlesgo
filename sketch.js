//global variables///////////////////////////////
        ...
        let mainBackgroundMusic; // Declare the music variable
        ...
        //upgrades
        //let pierceUpgrade = false; // Moved to global
        ...
        function bulletMechanics() {
            ...
            if (mouse.presses() && bulletCooldown === 0 && !shopOpen) { //prevent shooting in shop
        ...
        function draw() {
            ...
            background(0, 0, 0, 0); // Make background transparent
        ...
        function runGame() {
            if (!gamePaused) { // Only update game if not paused
                //background
                ...
                drawCountdownTimer();
                // drawCrosshair(mouse.x, mouse.y); // Moved to the main draw function
            }

            // Currency display (moved to draw function)
        }
